...
Theme management in the application service is used to switch between different color themes, each theme consisting of two modes: dark mode and light mode.
The library comes with many built-in theme data generated by [flex_color_scheme](https://pub.dev/packages/flex_color_scheme).

Below is the table of built-in themes:
