...
// Dell Genoa Green（戴尔翠绿）亮色主题
ThemeData dellGenoaGreenLightTheme = FlexThemeData.light(
  scheme: FlexScheme.dellGenoa, // 使用戴尔翠绿调色板
...
// Dell Genoa Green（戴尔翠绿）暗色主题
ThemeData dellGenoaGreenDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.dellGenoa, // 使用戴尔翠绿调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
