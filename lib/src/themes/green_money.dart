...
// Green Money（绿色货币）亮色主题
ThemeData greenMoneyLightTheme = FlexThemeData.light(
  scheme: FlexScheme.money, // 使用绿色货币调色板
...
// Green Money（绿色货币）暗色主题
ThemeData greenMoneyDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.money, // 使用绿色货币调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
