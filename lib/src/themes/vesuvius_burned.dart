...
// Vesuvius Burned（维苏威烧焦）亮色主题
ThemeData vesuviusBurnedLightTheme = FlexThemeData.light(
  scheme: FlexScheme.vesuviusBurn, // 使用维苏威烧焦方案
...
// Vesuvius Burned（维苏威烧焦）暗色主题
ThemeData vesuviusBurnedDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.vesuviusBurn, // 使用维苏威烧焦方案
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
