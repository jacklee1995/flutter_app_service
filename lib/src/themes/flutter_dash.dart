...
// Flutter Dash（Flutter虚线）亮色主题
ThemeData flutterDashLightTheme = FlexThemeData.light(
  scheme: FlexScheme.flutterDash, // 使用Flutter虚线调色板
...
// Flutter Dash（Flutter虚线）暗色主题
ThemeData flutterDashDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.flutterDash, // 使用Flutter虚线调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
