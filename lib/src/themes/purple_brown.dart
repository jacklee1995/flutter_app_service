...
// Purple Brown（紫褐色）亮色主题
ThemeData purpleBrownLightTheme = FlexThemeData.light(
  scheme: FlexScheme.purpleBrown, // 使用紫褐色方案
...
// Purple Brown（紫褐色）暗色主题
ThemeData purpleBrownDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.purpleBrown, // 使用紫褐色方案
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
