...
// Deep Blue Sea（深蓝色）亮色主题
ThemeData deepBlueSeaLightTheme = FlexThemeData.light(
  scheme: FlexScheme.deepBlue, // 使用深蓝色调色板
...
// Deep Blue Sea（深蓝色）暗色主题
ThemeData deepBlueSeaDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.deepBlue, // 使用深蓝色调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
