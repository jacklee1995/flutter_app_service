...
// Mosque Cyan（清真蓝绿色）亮色主题
ThemeData mosqueCyanLightTheme = FlexThemeData.light(
  scheme: FlexScheme.cyanM3, // 使用清真蓝绿色M3方案
...
// Mosque Cyan（清真蓝绿色）暗色主题
ThemeData mosqueCyanDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.cyanM3, // 使用清真蓝绿色M3方案
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
