...
// Oh Mandy Red（深红色）亮色主题
ThemeData ohMandyRedLightTheme = FlexThemeData.light(
  scheme: FlexScheme.mandyRed, // 使用深红色方案
...
// Oh Mandy Red（深红色）暗色主题
ThemeData ohMandyRedDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.mandyRed, // 使用深红色方案
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
