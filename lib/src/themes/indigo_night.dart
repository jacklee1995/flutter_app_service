...
// Indigo Night（靛蓝夜晚）亮色主题
ThemeData indigoNightLightTheme = FlexThemeData.light(
  scheme: FlexScheme.indigo, // 使用靛蓝调色板
...
// Indigo Night（靛蓝夜晚）暗色主题
ThemeData indigoNightDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.indigo, // 使用靛蓝调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
