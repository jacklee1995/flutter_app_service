...
// Lipstick Pink（口红粉）亮色主题
ThemeData lipstickPinkLightTheme = FlexThemeData.light(
  scheme: FlexScheme.pinkM3, // 使用口红粉调色板
...
// Lipstick Pink（口红粉）暗色主题
ThemeData lipstickPinkDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.pinkM3, // 使用口红粉调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
