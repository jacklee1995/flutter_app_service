...
// Green Jungle（绿色丛林）亮色主题
ThemeData greenJungleLightTheme = FlexThemeData.light(
  scheme: FlexScheme.jungle, // 使用绿色调色板
...
// Green Jungle（绿色丛林）暗色主题
ThemeData greenJungleDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.jungle, // 使用绿色调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
