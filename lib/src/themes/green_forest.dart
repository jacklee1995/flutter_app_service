...
// Green Forest（绿色森林）亮色主题
ThemeData greenForestLightTheme = FlexThemeData.light(
  scheme: FlexScheme.green, // 使用绿色调色板
...
// Green Forest（绿色森林）暗色主题
ThemeData greenForestDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.green, // 使用绿色调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
