...
// Willow Wasabi（柳树芥末）亮色主题
ThemeData willowWasabiLightTheme = FlexThemeData.light(
  scheme: FlexScheme.wasabi, // 使用柳树芥末方案
...
// Willow Wasabi（柳树芥末）暗色主题
ThemeData willowWasabiDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.wasabi, // 使用柳树芥末方案
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
