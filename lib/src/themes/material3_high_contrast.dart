...
// Material3 High Contrast（高对比度）亮色主题
ThemeData material3HighContrastLightTheme = FlexThemeData.light(
  scheme: FlexScheme.materialHc, // 使用Material3高对比度调色板
...
// Material3 High Contrast（高对比度）暗色主题
ThemeData material3HighContrastDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.materialHc, // 使用Material3高对比度调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
