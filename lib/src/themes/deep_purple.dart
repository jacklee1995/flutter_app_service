...
// Deep Purple（深紫色）亮色主题
ThemeData deepPurpleLightTheme = FlexThemeData.light(
  scheme: FlexScheme.deepPurple, // 使用深紫色调色板
...
// Deep Purple（深紫色）暗色主题
ThemeData deepPurpleDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.deepPurple, // 使用深紫色调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
