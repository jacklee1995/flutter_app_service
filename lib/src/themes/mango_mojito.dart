...
// Mango Mojito（芒果莫吉托）亮色主题
ThemeData mangoMojitoLightTheme = FlexThemeData.light(
  scheme: FlexScheme.mango, // 使用芒果莫吉托调色板
...
// Mango Mojito（芒果莫吉托）暗色主题
ThemeData mangoMojitoDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.mango, // 使用芒果莫吉托调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
