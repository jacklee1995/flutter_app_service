...
// Outer Space（深空灰）亮色主题
ThemeData outerSpaceLightTheme = FlexThemeData.light(
  scheme: FlexScheme.outerSpace, // 使用深空灰方案
...
// Outer Space（深空灰）暗色主题
ThemeData outerSpaceDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.outerSpace, // 使用深空灰方案
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
