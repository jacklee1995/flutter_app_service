...
// Indigo San Marino（靛蓝圣马力诺）亮色主题
ThemeData indigoSanMarinoLightTheme = FlexThemeData.light(
  scheme: FlexScheme.indigoM3, // 使用靛蓝圣马力诺调色板
...
// Indigo San Marino（靛蓝圣马力诺）暗色主题
ThemeData indigoSanMarinoDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.indigoM3, // 使用靛蓝圣马力诺调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
