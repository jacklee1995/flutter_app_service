...
// Yukon Gold Yellow（育空金黄）亮色主题
ThemeData yukonGoldYellowLightTheme = FlexThemeData.light(
  scheme: FlexScheme.yellowM3, // 使用育空金黄方案
...
// Yukon Gold Yellow（育空金黄）暗色主题
ThemeData yukonGoldYellowDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.yellowM3, // 使用育空金黄方案
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
