...
// Verdun Green（维尔登绿）亮色主题
ThemeData verdunGreenLightTheme = FlexThemeData.light(
  scheme: FlexScheme.verdunHemlock, // 使用维尔登绿方案
...
// Verdun Green（维尔登绿）暗色主题
ThemeData verdunGreenDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.verdunHemlock, // 使用维尔登绿方案
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
