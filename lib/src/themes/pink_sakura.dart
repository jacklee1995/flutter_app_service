...
// Pink Sakura（樱花粉）亮色主题
ThemeData pinkSakuraLightTheme = FlexThemeData.light(
  scheme: FlexScheme.sakura, // 使用樱花粉方案
...
// Pink Sakura（樱花粉）暗色主题
ThemeData pinkSakuraDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.sakura, // 使用樱花粉方案
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
