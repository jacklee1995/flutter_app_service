...
// Rust Deep Orange（锈橙）亮色主题
ThemeData rustDeepOrangeLightTheme = FlexThemeData.light(
  scheme: FlexScheme.deepOrangeM3, // 使用锈橙方案
...
// Rust Deep Orange（锈橙）暗色主题
ThemeData rustDeepOrangeDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.deepOrangeM3, // 使用锈橙方案
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
