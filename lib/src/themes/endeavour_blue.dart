...
// Endeavour Blue（奋斗蓝）亮色主题
ThemeData endeavourBlueLightTheme = FlexThemeData.light(
  scheme: FlexScheme.blueM3, // 使用奋斗蓝调色板
...
// Endeavour Blue（奋斗蓝）暗色主题
ThemeData endeavourBlueDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.blueM3, // 使用奋斗蓝调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
