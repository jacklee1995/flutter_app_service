...
// Material3 Purple（Material3紫色）亮色主题
ThemeData material3PurpleLightTheme = FlexThemeData.light(
  scheme: FlexScheme.materialBaseline, // 使用Material3基线调色板
...
// Material3 Purple（Material3紫色）暗色主题
ThemeData material3PurpleDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.materialBaseline, // 使用Material3基线调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
