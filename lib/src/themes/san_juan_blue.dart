...
// San Juan Blue（圣胡安蓝）亮色主题
ThemeData sanJuanBlueLightTheme = FlexThemeData.light(
  scheme: FlexScheme.sanJuanBlue, // 使用圣胡安蓝方案
...
// San Juan Blue（圣胡安蓝）暗色主题
ThemeData sanJuanBlueDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.sanJuanBlue, // 使用圣胡安蓝方案
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
