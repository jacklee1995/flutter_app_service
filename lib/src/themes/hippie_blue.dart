...
// Hippie Blue（嬉皮蓝）亮色主题
ThemeData hippieBlueLightTheme = FlexThemeData.light(
  scheme: FlexScheme.hippieBlue, // 使用嬉皮蓝调色板
...
// Hippie Blue（嬉皮蓝）暗色主题
ThemeData hippieBlueDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.hippieBlue, // 使用嬉皮蓝调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
