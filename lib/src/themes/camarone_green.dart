...
// Camarone Green（褐绿色）亮色主题
ThemeData camaroneGreenLightTheme = FlexThemeData.light(
  scheme: FlexScheme.greenM3, // 使用绿色M3调色板
...
// Camarone Green（褐绿色）暗色主题
ThemeData camaroneGreenDarkTheme = FlexThemeData.dark(
  scheme: FlexScheme.greenM3, // 使用绿色M3调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
